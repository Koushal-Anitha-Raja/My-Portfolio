...
const ResumeCard = ({ title, subTitle, GPA, des }) => {
  return (
    <div className="w-full h-1/2 group flex">
      ...
      <div
        className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg px-10 flex flex-col 
      justify-center gap-10 shadow-shadowOne"
      >
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm mt-2 text-gray-400 group-hover:text-white duratioin-300 ">
              {subTitle}
            </p>
          </div>
          <div>
